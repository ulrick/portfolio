...
function biznez_add_upsell() {
    $page = add_theme_page( __('Sketch Themes', 'biznez'), __('Sketch Themes', 'biznez'), 'administrator', 'sketch-themes', 'biznez_display_upsell' );
        ...
        <div id="Timeliner" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=30&product_id=30&hide_paysys=paypal_r" target="_blank"><?php _e( 'Buy Timeliner Pro', 'irex' ); ?></a>
                    <a class="buy  btn btn-info" href="http://sketchthemes.com/samples/timeliner-modeling-agency/" target="_blank"><?php _e( 'View Demo', 'irex' ); ?></a>
        ...
        <div id="biznez" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=19&product_id=19&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy Biznez Pro', 'biznez' ); ?></a>
                    <a class="buy  btn btn-info" href="http://demo.sketchthemes.com/preview-images/biznez/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://wordpress.org/themes/biznez-lite" target="_blank"><?php _e( 'Try Biznez Free', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="analytical" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=17&product_id=17&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy Analytical Pro', 'biznez' ); ?></a>
                    <a class="buy  btn btn-info" href="http://demo.sketchthemes.com/preview-images/analytical/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://wordpress.org/themes/analytical-lite" target="_blank"><?php _e( 'Try Analytical Free', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="bizstudio" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=14&product_id=14&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy BizStudio Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://demo.sketchthemes.com/preview/bizstudio/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://wordpress.org/themes/bizstudio-lite" target="_blank"><?php _e( 'Try BizStudio Lite', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="FullScreen" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=27&product_id=27&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy FullScreen Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://sketchthemes.com/samples/fullscreen-default-demo/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://www.sketchthemes.com/themes/fullscreen-onepager-responsive-wordpress-theme/" target="_blank"><?php _e( 'Try FullScreen Lite', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="Irex" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=15&product_id=15&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy Irex Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://demo.sketchthemes.com/preview/irex/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://www.sketchthemes.com/themes/irex-full-width-wordpress-theme/" target="_blank"><?php _e( 'Try Irex Lite', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="Swiftbiz" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
                    ...
                    <a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=13&product_id=13&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy Swiftbiz Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://demo.sketchthemes.com/preview/swiftbiz/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://www.sketchthemes.com/themes/swiftbiz-business-wordpress-theme/" target="_blank"><?php _e( 'Try Swiftbiz Lite', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="Sketchmini" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=24&product_id=24&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy Sketchmini Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://demo.sketchthemes.com/preview/sketchmini/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
                    <a class="free btn btn-success" href="http://www.sketchthemes.com/themes/sketchmini-free-wordpress-theme/#FreeDownloadButton" target="_blank"><?php _e( 'Try Sketchmini Lite', 'biznez' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div id="StoneAge" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/members/signup.php?price_group=11&product_id=11&hide_paysys=paypal_r
" target="_blank"><?php _e( 'Buy StoneAge Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://demo.sketchthemes.com/preview/stone-age/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
        ...
        <div id="3rd-wired" class="row-fluid">
            <div class="theme-container">
                ...
                <div class="theme-info span9">
					...
					<a class="buy btn btn-primary" href="http://www.sketchthemes.com/themes/3rd-wired-premium-wordpress-theme/" target="_blank"><?php _e( 'Buy 3rd-wired Pro', 'biznez' ); ?></a>
                    <a class="buy btn btn-info" href="http://demo.sketchthemes.com/preview/3rd-wired/" target="_blank"><?php _e( 'View Demo', 'biznez' ); ?></a>
