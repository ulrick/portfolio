...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'biznez'),
		'repeat-x'  => __('Repeat Horizontally', 'biznez'),
		'repeat-y'  => __('Repeat Vertically', 'biznez'),
		'repeat'    => __('Repeat All', 'biznez'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'biznez'),
		'top center'    => __('Top Center', 'biznez'),
		'top right'     => __('Top Right', 'biznez'),
		'center left'   => __('Middle Left', 'biznez'),
		'center center' => __('Middle Center', 'biznez'),
		'center right'  => __('Middle Right', 'biznez'),
		'bottom left'   => __('Bottom Left', 'biznez'),
		'bottom center' => __('Bottom Center', 'biznez'),
		'bottom right'  => __('Bottom Right', 'biznez')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'biznez'),
		'fixed'  => __('Fixed in Place', 'biznez')
		);
...
function of_recognized_font_styles() {
	$default = array(
		...
		'italic'      => __('Italic', 'biznez'),
		'bold'        => __('Bold', 'biznez'),
		'bold italic' => __('Bold Italic', 'biznez')
		);
