			...
			<div class="nbpro_midbdr">
				<div class="nbar_setting">
					<table style="width: 100%" class="nbar_settbl" cellpadding="9" >
						<tr>
							<td style="width: 170px !important;"><?php _e("Default Notification Bar:",'biznez'); ?></td>
							<td>
								...
								<a class="nbar_tooltip" title="<?php _e('This Notification Bar will be used for all Posts,Pages and Categories until you have not selected in page/post editor.','biznez'); ?>"></a>
							</td>
						</tr>
						<tr><td colspan="2" class="protheme"></td></tr>
						<tr>
						<table class="nbar_settbl proborder">
						<tr><td colspan="2"><?php _e("Where to show Default Notification Bar:",'biznez'); ?></td></tr>
						<tr class="">
							<td colspan="2">
								<label for="nbar_pages" class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_pages" value="true" />&nbsp;<?php _e("Pages",'biznez'); ?></label>
								<label for="nbar_posts" class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_posts" value="true" />&nbsp;<?php _e("Posts",'biznez'); ?></label>
								<label for="nbar_homep" class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_homep" value="true" />&nbsp;<?php _e("Home Page",'biznez'); ?></label>
								<label for="nbar_blogp" class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_blogp" value="true" />&nbsp;<?php _e("Blog Page",'biznez'); ?></label>		
								<label for="nbar_catgs" class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_catgs" value="true" />&nbsp;<?php _e("Categories",'biznez'); ?></label>	
								<label for="nbar_ctaxs" class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_ctaxs" value="true" />&nbsp;<?php _e("Custom Taxonomies",'biznez'); ?></label>		
								<label for="nbar_tags"  class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_tags" value="true" />&nbsp;<?php _e("Tags",'biznez'); ?></label>		
								<label for="nbar_date"  class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_date" value="true" />&nbsp;<?php _e("Date Archive",'biznez'); ?></label>													
								<label for="nbar_auth"  class="" ><input type="checkbox" class="nbpro_smallchkbox" name="" id="nbar_auth" value="true" />&nbsp;<?php _e("Author Page",'biznez'); ?></label>													
							</td>                                             
						</tr>
						</tr>
						</table>
