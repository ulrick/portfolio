		...
		<div class="nbpro_leftbox">
			...
			<div class="nbpro_block">
				<div class="nbpro_settings" style="border-radius:0 !important;border: 5px solid #0F344C !important;margin-bottom: 30px;">
					<div style=" width: 320px;" class="nbpro_distxt"><?php _e('SELECT NOTIFICATION BAR','biznez'); ?></div>
						<form method="get" action="">
							<div style="float:left;margin-top:14px;">
								<select style="font-family: bitter;font-size: 14px; height: 27px; width: 210px;" name="edit"> 	
									...
									?>
								</select><a class="nbar_tooltip" title="<?php _e('Select Notification Bar to edit.','biznez'); ?>"></a>
							</div>
			...
			<form class="nbar_editform" id="nbar_editform" method="post" action="/">
				...
				<div class="nbpro_block">
					<div class="nbpro_settings">
						<div class="nbpro_distxt"><?php _e('DEFAULT SETTINGS','biznez'); ?></div>
					...
					<div class="nbpro_extendbox">
						...
						<div class="nbpro_midbdr">
							<table style="width:650px;" class="nbar_edittbl">
								<tbody>
									<tr>
										<td><?php _e("Default State :",'biznez'); ?></td>
										<td>
										...
										<a class="nbar_tooltip" title="<?php _e("Set the default state (Open/Close) of Notification bar.",'biznez'); ?>"></a></td>
									</tr>
									<tr>
										<td><?php _e("Position :",'biznez'); ?></td>
										<td>
											...
											<a class="nbar_tooltip" title="<?php _e("Set the default position (Top/Bottom) of Notification bar.",'biznez'); ?>"></a>
										</td>
									</tr>
									
									<tr>
										<td><?php _e("Stay Time :",'biznez'); ?></td>
										<td><input type="text" id="stayTime" name="<?php echo $option; ?>[stayTime]" value="<?php echo $options['stayTime'] ?>" size="5" />&nbsp;<small>(<?php _e("in Seconds",'biznez') ?>)&nbsp;
											<a class="nbar_tooltip" title="<?php _e("Stay time will work with only 'Open' default state of Notification Bar. (default: 10 sec.)",'biznez'); ?>"></a></td></small></td>
									</tr>
									<tr>
										<td><?php _e("Background Color :",'biznez'); ?></td>
										<td>
									...
									<tr>
										<td><?php _e("Message/Text to Display :",'biznez'); ?></td>
										<td><textarea rows="4" cols="30" name="<?php echo $option; ?>[message]" ><?php echo stripslashes($options['message']); ?></textarea><br/><small>(<?php _e('Can also Input HTML Text','biznez') ?>)</small></td>
									</tr>
									<tr>
										<td><?php _e("Message Font-Size :",'biznez'); ?></td>
										<td><input type="text" name="<?php echo $option; ?>[messageFont]" value="<?php echo $options['messageFont'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
									</tr>
									<tr>
										<td><?php _e("Message Font-Color :",'biznez'); ?></td>
										<td>
											<div class="nbar_colwrap">
				...
				<div class="nbpro_block">
					<div class="nbpro_settings">
						<div class="nbpro_distxt"><?php _e('LINK BUTTON SETTINGS','biznez'); ?></div>
						<div class="nbpro_savebox"><input name="nbpro_saves" type="submit" value="Save" /><a class="nbpro_plus_minus" href="Javascript:void(0);"></a><div class="nbpro_clear"></div></div><div class="nbpro_clear"></div>
					</div>
					<div class="nbpro_extendbox">
						<div class="nbpro_topbdr"></div>
						<div class="nbpro_midbdr">
							<table style="width:650px;" class="nbar_edittbl" >
								<tbody>
									<tr>
										<td><?php _e("Button URL :",'biznez'); ?></td>
										<td><input class="large_text_box" type="text" name="<?php echo $option; ?>[linkUrl]" value="<?php echo $options['linkUrl'] ?>" /></td>
									</tr>
									<tr>
										<td><?php _e("Button Text :",'biznez'); ?></td>
										<td><input class="large_text_box" type="text" name="<?php echo $option; ?>[linkText]" value="<?php echo stripslashes($options['linkText']); ?>" /></td>
									</tr>
									<tr>
										<td><?php _e("Font-Size :",'biznez'); ?></td>
										<td><input type="text" name="<?php echo $option; ?>[linkFont]" value="<?php echo $options['linkFont'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
									</tr>
									<tr>
										<td><?php _e("Button Font-Color :",'biznez'); ?></td>
										<td>
											<div class="nbar_colwrap">
									...
									<tr>
										<td><?php _e("Button BG-Color :",'biznez'); ?></td>
										<td>
											<div class="nbar_colwrap">
									...
									<tr>
										<td><?php _e("Button Target :",'biznez'); ?></td>
										<td>
				...
				<div class="nbpro_block">
					<div class="nbpro_settings">
						<div class="nbpro_distxt"><?php _e('SOCIAL BUTTONS SETTINGS','biznez'); ?></div>
						<div class="nbpro_savebox"><input name="nbpro_saves" type="submit" value="Save" /><a class="nbpro_plus_minus" href="Javascript:void(0);"></a><div class="nbpro_clear"></div></div><div class="nbpro_clear"></div>
					</div>
					<div class="nbpro_extendbox">
						<div class="nbpro_topbdr"></div>
				...
				<div class="nbpro_extmsg_chk"><label class="nbpro_mkchk <?php if($options['extendMesg']){ ?>checked<?php } ?>" for="nbar_extchk"></label><input type="checkbox" class="nbpro_chkbox" id="nbar_extchk"  name="<?php echo $option; ?>[extendMesg]" <?php if($options['extendMesg']){ ?> checked <?php } ?> value="true"/> <?php _e('Enable "Extended Notification Bar" ','biznez'); ?></div>
				
				<div style="<?php if($options['extendMesg']){ ?><?php }else{ ?>display:none;<?php } ?>" class="nbpro_extmsg nbpro_block">
					<div class="nbpro_settings">
						<div class="nbpro_distxt"><?php _e('EXTENDED NOTIFICATION BAR SETTINGS','biznez'); ?></div>
					...
					<div class="nbpro_extendbox">
						...
						<div class="nbpro_midbdr">
									...
									<div class="nbpro_smidbdr">
										<table style="width:650px;" class="nbar_edittbl" >
											<tbody>
												...
												<tr>
													<td><?php _e("Disable Counter Message:",'biznez'); ?></td>
													<td>
												...
												<tr>
													<td><?php _e("Message Open Time:",'biznez'); ?></td>
													<td><input type="text" id="extMesgOpenTime" name="<?php echo $option; ?>[extMesgOpenTime]" value="<?php echo $options['extMesgOpenTime'] ?>" size="5" />&nbsp;<small>(<?php _e("in Seconds",'biznez') ?>)&nbsp;</small><a class="nbar_tooltip" title="<?php _e("Extend Message Open Time Work With Only 'Open' state. And Extend Message will Open After This Time Duration. (default: 4 sec.)",'biznez'); ?>"></a></td>
												</tr>
												
												<tr>
													<td><?php _e("Message Close Time:",'biznez'); ?></td>
													<td><input type="text" id="extMesgCloseTime" name="<?php echo $option; ?>[extMesgCloseTime]" value="<?php echo $options['extMesgCloseTime'] ?>" size="5" />&nbsp;<small>(<?php _e("in Seconds",'biznez') ?>)&nbsp;</small><a class="nbar_tooltip" title="<?php _e("Extend Message Close Time Work With Only 'Open' state. And Extend Message will Close After This Time Duration. (default: 4 sec.)",'biznez'); ?>"></a></td>
												</tr>
												
												<tr>
													<td><?php _e("Message Template:",'biznez'); ?></td>
												...
												<tr>
													<td><?php _e("Mesaage/Text to Display:",'biznez'); ?></td>
													<td>
													<?php 
														global $wp_version;
														if($wp_version >=3.3){
														...
														?>												
															<textarea rows="4" cols="30" name="<?php echo $option; ?>[extendMesgText]" ><?php echo stripslashes($options['extendMesgText']); ?></textarea><br/><small>(<?php _e('Can also Input HTML Text','biznez') ?>)</small>
														<?php
														}
												...
												<tr>
													<td><?php _e("Message Font-Size:",'biznez'); ?></td>
													<td><input type="text" name="<?php echo $option; ?>[extendMesgFont]" value="<?php echo $options['extendMesgFont'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
												</tr>
												<tr>
													<td><?php _e("Message Font-Color:",'biznez'); ?></td>
													<td>
							...
							<div class="nbpro_block nbpro_smallblk">
								<div class="nbpro_settings">
									<div class="nbpro_distxt"><?php _e('IMAGE SETTINGS','biznez'); ?></div>
									<div class="nbpro_savebox"><input name="nbpro_saves" type="submit" value="Save" /><a class="nbpro_plus_minus" href="Javascript:void(0);"></a><div class="nbpro_clear"></div></div><div class="nbpro_clear"></div>
								</div>
								<div class="nbpro_extendbox">
									<div class="nbpro_stopbdr"></div>
									<div class="nbpro_smidbdr">
										<table style="width:650px;" class="nbar_edittbl" >
											<tbody>
												<tr>
													<td> <?php _e("Image URL/PATH:",'biznez'); ?></td>
													<td>
												...
												<tr>
													<td><?php _e("Image Width:",'biznez'); ?></td>
													<td><input type="text" name="<?php echo $option; ?>[extendMesgImgWidth]" value="<?php echo $options['extendMesgImgWidth'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
												</tr>
												<tr>
													<td><?php _e("Image Height:",'biznez'); ?></td>
													<td><input type="text" name="<?php echo $option; ?>[extendMesgImgHeight]" value="<?php echo $options['extendMesgImgHeight'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
												</tr>
												<tr>
													<td><?php _e("Image Border:",'biznez'); ?></td>
													<td><input type="text" name="<?php echo $option; ?>[extendMesgImgBorder]" value="<?php echo $options['extendMesgImgBorder'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
												</tr>
												<tr>
													<td><?php _e("Image Border-Color:",'biznez'); ?></td>
													<td>
														<div class="nbar_colwrap">
									...
									<div class="nbpro_smidbdr">
										<table style="width:650px;" class="nbar_edittbl" >
											<tbody>
												...
												<tr>
													<td><?php _e("Font-Size:",'biznez'); ?></td>
													<td><input type="text" name="<?php echo $option; ?>[extendMesgLinkFont]" value="<?php echo $options['extendMesgLinkFont'] ?>" size="5" />&nbsp;<small>(<?php _e('in Pixel','biznez') ?>)</small></td>
												</tr>
												<tr>
													<td><?php _e("Button Font-Color:",'biznez'); ?></td>
													<td>
