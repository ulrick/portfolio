...
function biznez_pagenavi($before = '', $after = '') {
    ...
    $pagenavi_options['first_text'] = __('First Page','biznez');
    $pagenavi_options['last_text'] = __('Last Page','biznez');
...
?>
<?php
		 if(sketch_get_option($shortname.'_skenavfull','biznez')) {  ?>
...
// Circular Latest Work
 if(sketch_get_option($shortname.'_circal_work','biznez')) { ?>
<script type="text/javascript">
			jQuery(document).ready(function() {
