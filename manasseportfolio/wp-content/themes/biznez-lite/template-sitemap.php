			...
			<div id="site_map" class="clearfix">
				...
				<div class="sitemap-first sitemap-rows">
					<div class="left_site sitemap-box">
						<div class="title"><?php _e('Pages','biznez');?></div>
						<ul><?php wp_list_pages('title_li='); ?></ul>
					</div>
					<div class="mid_site sitemap-box">
						<div class="title"><?php _e('Categories','biznez');?></div>
						<ul><?php wp_list_categories('title_li='); ?></ul>
					</div>
					<div class="right_site sitemap-box">
						<div class="title"><?php _e('Blog Entries','biznez');?></div>
						<ul>
						<?php
						$args=array(
						'post_type'=>'post',
				...
				<div class="sitemap-second sitemap-rows">
					<div class="post-heading title"><?php _e('Posts Per Category','biznez');?></div>
					<?php
					$args = array(
					'post_type'                     => 'post',
					'child_of'                 => 0,
