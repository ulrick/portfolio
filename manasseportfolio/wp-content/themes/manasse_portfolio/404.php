	  ...
	  <div class="grid_24">
	   ...
	   <div class="pagetitle-wrap grid_24 clearfix">
			...
			<div class="page-title grid_11">
				...
				<?php _e('Error 404 - Not Found','biznez'); ?>
		...
		<div id="content" class="grid_16 alpha">
			...
			<span class="not-found-txt"><?php _e('Page Not Found.', 'biznez' ); ?></span>

			<p><?php _e( 'Apologies, but the page you requested could not be found.', 'biznez' ); ?></p>
