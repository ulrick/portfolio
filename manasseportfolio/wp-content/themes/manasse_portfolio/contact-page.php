	...
	<div id="container" class="clearfix">
	  <div class="container_24 clearfix">	  
		...
		<div id="contact-page" class="contact-left grid_14">
			...
			<?php else :  ?>
			<div class="post">
				<h2><?php _e('Page Does Not Exist','biznez'); ?></h2>
			</div>
			<?php endif; ?>			
			<div class="clear"></div>
		</div>
		 ...
		 <div class="address-area">	
			<div class="add-title">
				<?php if(sketch_get_option($shortname."_add_title")){ 	echo (sketch_get_option($shortname."_add_title"));} else{ _e('Office Address','biznez'); } ?>
			</div>
