	  ...
	  if(isset($instance['follow_delicious'])){
	   ...
	   if(isset($instance['follow_size'])){
        ...
        ?>
		 ...
		 <?php _e('Title:','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php if(isset($title)){ echo $title; } ?>" />
         </label></p>
		  <p>
         <label for="<?php echo $this->get_field_id('follow_size'); ?>"><?php _e('Icon size','biznez'); ?> 
			<select id="<?php echo $this->get_field_id('follow_size'); ?>" name="<?php echo $this->get_field_name('follow_size'); ?>">
				<option <?php if(isset($instance['follow_size'])){ if ( '16' == $instance['follow_size'] ) echo 'selected="selected"'; } ?> value="16"><?php _e('16px','biznez');?></option>
				<option <?php if(isset($instance['follow_size'])){ if ( '26' == $instance['follow_size'] ) echo 'selected="selected"'; } ?> value="26"><?php _e('26px','biznez');?></option>
				<option <?php if(isset($instance['follow_size'])){ if ( '32' == $instance['follow_size'] ) echo 'selected="selected"'; } ?> value="32"><?php _e('32px','biznez');?></option>
				<option <?php if(isset($instance['follow_size'])){ if ( '48' == $instance['follow_size'] ) echo 'selected="selected"'; } ?> value="48"><?php _e('48px','biznez');?></option>
			</select>	
		 </label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_linkedin'); ?>"><?php _e('Link for Linkedin','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_linkedin'); ?>" name="<?php echo $this->get_field_name('follow_linkedin'); ?>" type="text" value="<?php if(isset($follow_linkedin)){ echo $follow_linkedin; }?>" /></label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_facebook'); ?>"><?php _e('Link for Facebook','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_facebook'); ?>" name="<?php echo $this->get_field_name('follow_facebook'); ?>" type="text" value="<?php if(isset($follow_facebook)){ echo $follow_facebook; }?>" /></label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_twitter'); ?>"><?php _e('Link for Twitter','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_twitter'); ?>" name="<?php echo $this->get_field_name('follow_twitter'); ?>" type="text" value="<?php if(isset($follow_twitter)){ echo $follow_twitter; }?>" /></label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_flickr'); ?>"><?php _e('Link for Flickr','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_flickr'); ?>" name="<?php echo $this->get_field_name('follow_flickr'); ?>" type="text" value="<?php if(isset($follow_flickr)){ echo $follow_flickr; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_gplusicon'); ?>"><?php _e('Link for Google+','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_gplusicon'); ?>" name="<?php echo $this->get_field_name('follow_gplusicon'); ?>" type="text" value="<?php if(isset($follow_gplusicon)){ echo $follow_gplusicon; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_skype'); ?>"><?php _e('Skype UserID','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_skype'); ?>" name="<?php echo $this->get_field_name('follow_skype'); ?>" type="text" value="<?php if(isset($follow_skype)){ echo $follow_skype; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_youtube'); ?>"><?php _e('Link for YouTube','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_youtube'); ?>" name="<?php echo $this->get_field_name('follow_youtube'); ?>" type="text" value="<?php if(isset($follow_youtube)){ echo $follow_youtube; }?>" /></label>
         </p>
		  <p>
			<label for="<?php echo $this->get_field_id('follow_wordpress'); ?>"><?php _e('Link for Wordpress','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_wordpress'); ?>" name="<?php echo $this->get_field_name('follow_wordpress'); ?>" type="text" value="<?php if(isset($follow_wordpress)){ echo $follow_wordpress; }?>" /></label>
         </p>
		  <p>
			<label for="<?php echo $this->get_field_id('follow_dribble'); ?>"><?php _e('Link for Dribble','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_dribble'); ?>" name="<?php echo $this->get_field_name('follow_dribble'); ?>" type="text" value="<?php if(isset($follow_dribble)){ echo $follow_dribble; }?>" /></label>
         </p>
		  <p>
			<label for="<?php echo $this->get_field_id('follow_pinterest'); ?>"><?php _e('Link for Pinterest','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_pinterest'); ?>" name="<?php echo $this->get_field_name('follow_pinterest'); ?>" type="text" value="<?php if(isset($follow_pinterest)){ echo $follow_pinterest; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_vimeo'); ?>"><?php _e('Link for Vimeo','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_vimeo'); ?>" name="<?php echo $this->get_field_name('follow_vimeo'); ?>" type="text" value="<?php if(isset($follow_vimeo)){ echo $follow_vimeo; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_deviantart'); ?>"><?php _e('Link for Deviantart','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_deviantart'); ?>" name="<?php echo $this->get_field_name('follow_deviantart'); ?>" type="text" value="<?php if(isset($follow_deviantart)){ echo $follow_deviantart; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_tumblr'); ?>"><?php _e('Link for Tumblr','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_tumblr'); ?>" name="<?php echo $this->get_field_name('follow_tumblr'); ?>" type="text" value="<?php if(isset($follow_tumblr)){ echo $follow_tumblr; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_stumbleupon'); ?>"><?php _e('Link for Stumbleupon','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_stumbleupon'); ?>" name="<?php echo $this->get_field_name('follow_stumbleupon'); ?>" type="text" value="<?php if(isset($follow_stumbleupon)){ echo $follow_stumbleupon; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_picasa'); ?>"><?php _e('Link for Picasa','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_picasa'); ?>" name="<?php echo $this->get_field_name('follow_picasa'); ?>" type="text" value="<?php if(isset($follow_picasa)){ echo $follow_picasa; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_friendfeed'); ?>"><?php _e('Link for Friendfeed','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_friendfeed'); ?>" name="<?php echo $this->get_field_name('follow_friendfeed'); ?>" type="text" value="<?php if(isset($follow_friendfeed)){ echo $follow_friendfeed; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_slideshare'); ?>"><?php _e('Link for Slideshare','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_slideshare'); ?>" name="<?php echo $this->get_field_name('follow_slideshare'); ?>" type="text" value="<?php if(isset($follow_slideshare)){ echo $follow_slideshare; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_behance'); ?>"><?php _e('Link for Behance','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_behance'); ?>" name="<?php echo $this->get_field_name('follow_behance'); ?>" type="text" value="<?php if(isset($follow_behance)){ echo $follow_behance; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_github'); ?>"><?php _e('Link for Github','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_github'); ?>" name="<?php echo $this->get_field_name('follow_github'); ?>" type="text" value="<?php if(isset($follow_github)){ echo $follow_github; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_reddit'); ?>"><?php _e('Link for Reddit','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_reddit'); ?>" name="<?php echo $this->get_field_name('follow_reddit'); ?>" type="text" value="<?php if(isset($follow_reddit)){ echo $follow_reddit; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_foursquare'); ?>"><?php _e('Link for Foursquar','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_foursquare'); ?>" name="<?php echo $this->get_field_name('follow_foursquare'); ?>" type="text" value="<?php if(isset($follow_foursquare)){ echo $follow_foursquare; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_digg'); ?>"><?php _e('Link for Digg','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_digg'); ?>" name="<?php echo $this->get_field_name('follow_digg'); ?>" type="text" value="<?php if(isset($follow_digg)){ echo $follow_digg; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_delicious'); ?>"><?php _e('Link for Delicious','biznez'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_delicious'); ?>" name="<?php echo $this->get_field_name('follow_delicious'); ?>" type="text" value="<?php if(isset($follow_delicious)){ echo $follow_delicious; }?>" /></label>
         </p>
        <?php 
    }
}
