	...
	<div class="nbpro_btmbdr">
		...
		<table class="proborder" cellspacing="0" style="margin: 0 12px;width: 95%;">
		   <tr class="nbar_tr2"> 
			   ...
			   <td><font style="font-size:10px;color:#A40B0B">&nbsp;&nbsp;<?php _e("* Do not use spaces or special characters.",'biznez'); ?></font></td>    
			   </td>
		...
		<div class="nbpro_leftbox">
			...
			<div id="nbar_addwrap">
				<div class="nbpro_settings">
					<div class="nbpro_distxt"><?php _e('DEFAULT (GLOBAL) NB SETTINGS','biznez'); ?></div>
				...
				<div class="nbpro_settings">
					<div class="nbpro_distxt"><?php _e('TABLE OF NOTIFICATION BARS','biznez'); ?></div>
					<div class="nbpro_savebox"><a class="nbpro_plus_minus" href="Javascript:void(0);"></a><div class="nbpro_clear"></div></div><div class="nbpro_clear"></div>
				</div>
				<div class="nbpro_extendbox">
					<?php get_nbars(); ?>
