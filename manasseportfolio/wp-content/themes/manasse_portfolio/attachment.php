...
<div id="container" class="clearfix">
	<div class="container_24 clearfix">
      ...
      <div class="pagetitle-wrap clearfix"> <div class="page-title"><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s', 'biznez' ), get_the_title( $post->post_parent ) ) ); ?>" data-rel="gallery">
        <?php 			/* translators: %s - title of parent post */
							printf( __( '<span class="meta-nav">&larr;</span> %s', 'biznez' ), get_the_title( $post->post_parent ) );
		?>
        </a> </p>
      <?php endif; ?>
      <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="skepost-meta">
          <?php
							printf( __( '<span class="%1$s">by</span> %2$s', 'biznez' ),
								'meta-prep meta-prep-author',
								sprintf( '<span class="author"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
									get_author_posts_url( get_the_author_meta( 'ID' ) ),
									sprintf( esc_attr__( 'View all posts by %s', 'biznez' ), get_the_author() ),
									get_the_author()
								));
			?>
          <span class="skepost-meta-sep"> | </span>
          <?php
							printf( __( '<span class="%1$s">Published</span> %2$s', 'biznez' ),
							...
							if ( wp_attachment_is_image() ) {
								...
								printf( __( 'Full size is %s pixels', 'biznez' ),
									sprintf( '<a href="%1$s" title="%2$s">%3$s &times; %4$s</a>',
										wp_get_attachment_url(),
										esc_attr( __( 'Link to full-size image', 'biznez' ) ),
										$metadata['width'],
										$metadata['height']
									));
							}
			?>
          <?php edit_post_link( __( 'Edit', 'biznez' ), '<span class="skepost-meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
        </div>
        <!-- skepost-meta -->
...
?>
          ...
          <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'biznez' ) ); ?>
          <?php wp_link_pages( array( 'before' => '<div class="page-link">' . __( 'Pages:', 'biznez' ), 'after' => '</div>' ) ); ?>
        </div>
        <!-- .ske-post-content -->
        
        <div class="ske-post-utility">
          <?php edit_post_link( __( 'Edit', 'biznez' ), ' <span class="edit-link">', '</span>' ); ?>
        </div>
        <!-- .ske-post-utility --> 
